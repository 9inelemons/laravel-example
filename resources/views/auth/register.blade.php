                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="inn" type="text" class="form-control @error('inn') is-invalid @enderror" name="inn" value="{{ old('inn') }}" required autocomplete="inn">
                        ...
                        <div class="form-group row">
                            <label for="organization" class="col-md-4 col-form-label text-md-right">{{ __('Название организации') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" value="{{ old('phone') }}" data-mask="+7 (000) 000 00 00" placeholder="+7 (___) ___ __-__" class="form-control @error('organization') is-invalid @enderror" name="phone" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-4 col-form-label text-md-right">{{ __('Описание (необязательное поле)') }}</label>
